...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mission_control_topic', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('week', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('day', self.gf('django.db.models.fields.CharField')(max_length=120)),
    ...
    models = {
        ...
        u'mission_control.topic': {
            ...
            'day': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
            'week': ('django.db.models.fields.CharField', [], {'max_length': '120'})
        }
    }
